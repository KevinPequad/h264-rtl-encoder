...
- the CABAC P16x16 cross-plane chroma-AC gate now also guards default-amplitude complementary checker masks `Cb0x5/Cr0xA` and `Cb0xA/Cr0x5`, extra asymmetric two-/three-block skew pairs (`Cb0x3/Cr0x5`, `Cb0x5/Cr0x3`, `Cb0x1/Cr0x7`, `Cb0x7/Cr0x1`, `Cb0x1/Cr0xB`, `Cb0xB/Cr0x1`, `Cb0x2/Cr0xB`, `Cb0xB/Cr0x2`), default-amplitude two-block off-diagonal, diagonal-skew, and edge-adjacent reciprocal pairs (`Cb0x3/Cr0x6`, `Cb0x6/Cr0x3`, `Cb0x5/Cr0x6`, `Cb0x6/Cr0x5`, `Cb0x9/Cr0xA`, `Cb0xA/Cr0x9`, `Cb0xB/Cr0xC`, `Cb0xC/Cr0xB`, `Cb0x3/Cr0x9`, `Cb0x9/Cr0x3`, `Cb0x6/Cr0xA`, `Cb0xA/Cr0x6`, `Cb0x5/Cr0xC`, `Cb0xC/Cr0x5`, `Cb0xA/Cr0x3`, `Cb0x3/Cr0xA`, `Cb0x6/Cr0xC`, `Cb0xC/Cr0x6`), low-amplitude and high-amplitude three-plus-one-block asymmetric complements `Cb0x7/Cr0x8`/`Cb0x8/Cr0x7`, default-amplitude three-block reciprocal complements `Cb0x7/Cr0xE`, `Cb0xE/Cr0x7`, `Cb0xB/Cr0xD`, and `Cb0xD/Cr0xB`, default-amplitude same-quadrant all-but-one/singleton mirrors `Cb0xB/Cr0x4`, `Cb0x4/Cr0xB`, `Cb0xD/Cr0x2`, and `Cb0x2/Cr0xD`, plus the complete checked +/-32 sign matrices for the targeted high-amplitude all-but-one/singleton mirror families `Cb0x1/Cr0xE`, `Cb0xE/Cr0x1`, `Cb0xD/Cr0x2`, `Cb0x2/Cr0xD`, `Cb0xB/Cr0x4`, `Cb0x4/Cr0xB`, `Cb0x7/Cr0x8`, and `Cb0x8/Cr0x7`; the complementary-checker high-amplitude sign probe now locks all +/-32 `Cb0x5/Cr0xA` and `Cb0xA/Cr0x5` sign endpoints as strict two-frame FFmpeg decodes, and the staged checker CBF-walk rejection probe proves a blanket plane-local CBF-walk expansion for those checker families regresses an already-strict Cr-positive control (`...6b7fff -> ...6bbecf`, FFmpeg `bytestream -21`); the former high-amplitude `Cb0x2/Cr0xD` and `Cb0x4/Cr0xB` miss families strict-decode via a scoped Cr residual payload context bank, and the former high-amplitude reciprocal `Cb0xB/Cr0x4`, split-row `Cb0x3/Cr0xC`, and adjacent skew-pair `Cb0x3/Cr0x5` / `Cb0x6/Cr0x9` / `Cb0x9/Cr0x6` miss directions now strict-decode through narrowly-scoped plane-local chroma-AC CBF neighbour walks; the DEBUG B4 trace-contrast gate locks exact `Cb0xB/Cr0x4` tails (`...6b7fcf7f7b` / `...6b7edef7fa`), coded blocks `[0,1,3,6]`, CBF selector walk `[0,1,2,2,4,4,4,5]`, and the existing `Cb0x4/Cr0xB` mirror split-bank guard; the split-row repair-boundary diagnostic locks the checked-in `Cb0x3/Cr0xC` positive-Cb/negative-Cr strict tails (`...6b7ede`) and proves the older Cr-side split payload-bank tweak is non-canonical because it changes the strict stream tail (`...6b7efd5f`).
- the CABAC P16x16 cross-plane chroma-AC gate now locks additional same-mask
  Cb/Cr controls (`Cb0x2/Cr0x2`, `Cb0x4/Cr0x4`, `Cb0x6/Cr0x6`,
  `Cb0x7/Cr0x7`, `Cb0x9/Cr0x9`, `Cb0xB/Cr0xB`, `Cb0xD/Cr0xD`,
  and `Cb0xE/Cr0xE`) plus high-amplitude all-but-one same-mask mirrors
  (`Cb0x7/Cr0x7`, `Cb0xB/Cr0xB`, `Cb0xD/Cr0xD`, and `Cb0xE/Cr0xE`),
  with the top-row `Cb0x7/Cr0x7` mirror now locked across the +/-32 sign
  matrix, as strict two-frame FFmpeg decodes with exact plane-local SAD and
  final P-slice tails
