...
| `scripts/run_cabac_p16x16_chroma_residual_red_check.sh` | Focused CABAC `P_L0_16x16` chroma residual gate covering 4:2:0, 4:2:2, 10-bit, plane-isolated DC/AC payloads, and strict FFmpeg decode |
