...
- `scripts/run_cabac_p16x16_chroma_ac_high_amp_miss_probe.py` | Promotion/quadrant-complement gate for high-amplitude Cb singleton / Cr all-but-one chroma-AC complements; locks strict two-frame FFmpeg decode, exact final-slice tails, and expected plane-local SAD for all sixteen `+/-32` sign combinations across `0x1/0xe`, `0x2/0xd`, `0x4/0xb`, and `0x8/0x7` |
