...
| `scripts/run_cabac_p16x16_chroma_residual_red_check.sh` | Legacy-named promoted gate proving integrated CABAC P16x16 Cb/Cr DC-only and Cb/Cr DC+AC residual smoke streams strict-decode with FFmpeg, decoded-plane sanity checks, plane-local DC MB counters, and plane-local AC block counters after running the chroma residual wiring audit |
