...
- the CABAC P16x16 cross-plane chroma-AC gate now locks additional same-mask
  ...
  and `Cb0xE/Cr0xE`) as strict two-frame FFmpeg decodes with exact
  plane-local SAD and final P-slice tails
