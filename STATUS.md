...
| `scripts/run_cabac_p16x16_chroma_ac_high_amp_trace_probe.py` | DEBUG_CABAC_P16X16 scoped-bank smoke for the promoted high-amplitude `Cb0x2/Cr0xd` sign-family against the reciprocal `Cb0xd/Cr0x2` strict-pass control; proves the target family uses the high-bit Cr residual payload context bank while the reciprocal control remains on the historical shared bank |
