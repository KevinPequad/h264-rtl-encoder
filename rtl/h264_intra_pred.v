    ...
    always @(*) begin
        ...
        for (row_idx = 0; row_idx < 4; row_idx = row_idx + 1) begin
            for (col_idx = 0; col_idx < 4; col_idx = col_idx + 1) begin
                ...
                if (top_avail)
                    sad_v_c = sad_v_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (orig_pix_c >= pred_pix_c)
                    ...
                    abs_diff_c = {1'b0, pred_pix_c} - {1'b0, orig_pix_c};
                if (left_avail)
                    sad_h_c = sad_h_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (orig_pix_c >= pred_pix_c)
                    ...
                    abs_diff_c = {1'b0, pred_pix_c} - {1'b0, orig_pix_c};
                sad_d_c = sad_d_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (orig_pix_c >= pred_pix_c)
                    ...
                    abs_diff_c = {1'b0, pred_pix_c} - {1'b0, orig_pix_c};
                if (top_avail)
                    sad_ddl_c = sad_ddl_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (top_avail && left_avail && top_left_avail)
                    sad_ddr_c = sad_ddr_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (orig_pix_c >= pred_pix_c)
                    ...
                    abs_diff_c = {1'b0, pred_pix_c} - {1'b0, orig_pix_c};
                if (top_avail && left_avail && top_left_avail)
                    sad_vr_c = sad_vr_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (orig_pix_c >= pred_pix_c)
                    ...
                    abs_diff_c = {1'b0, pred_pix_c} - {1'b0, orig_pix_c};
                if (top_avail && left_avail && top_left_avail)
                    sad_hd_c = sad_hd_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (orig_pix_c >= pred_pix_c)
                    ...
                    abs_diff_c = {1'b0, pred_pix_c} - {1'b0, orig_pix_c};
                if (top_avail)
                    sad_vl_c = sad_vl_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
                ...
                if (orig_pix_c >= pred_pix_c)
                    ...
                    abs_diff_c = {1'b0, pred_pix_c} - {1'b0, orig_pix_c};
                if (left_avail)
                    sad_hu_c = sad_hu_c + {{(SAD_W-BD1){1'b0}}, abs_diff_c};
            end
        end
