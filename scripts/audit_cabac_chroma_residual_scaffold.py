...
CHECKS: tuple[tuple[str, str, str], ...] = (
    ...
    (
        ...
        r"CB_MASK\s*=\s*0xB.*?CR_MASK\s*=\s*0x4.*?STAGED_SPLIT_CTX.*?4'hb\)\s*&&.*?4'h4.*?STAGED_CB_PAYLOAD_CTX_COND.*?STAGED_DUAL_PAYLOAD_CTX_COND.*?EXPECTED_BASELINE_MISSES\s*=\s*\{.*?\(160,\s*160\):\s*\(\"0000000141d008086bfedff5\",\s*\"bytestream -4\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bffef75\",\s*\"corrupt decoded frame\"\).*?EXPECTED_MISSES\s*=\s*\{.*?cr_payload_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfedffd73\",\s*\"bytestream -3\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bffef7df2\",\s*\"corrupt decoded frame\"\).*?cb_payload_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfacdf5f7\",\s*\"bytestream -11\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bfafe77f7\",\s*\"bytestream -23\"\).*?dual_payload_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfacdf577f4\",\s*\"corrupt decoded frame\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bfafe77f75d\",\s*\"corrupt decoded frame\"\).*?Cr-side, Cb-side, and both-plane.*?split-context extensions",
    ),
    (
