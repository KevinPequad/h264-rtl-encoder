...
CHECKS: tuple[tuple[str, str, str], ...] = (
    ...
    (
        "bitstream_repairs_b4_split_row_and_skew_pair_plane_local_cbf_walk",
        "rtl/h264_bitstream.v",
        r"cabac_chroma_ac_any_high_amp.*?cabac_chroma_ac_cr_plane_has_negative.*?cabac_chroma_ac_cb_plane_nz_mask\(\)\s*==\s*4'hb.*?cabac_chroma_ac_cr_plane_nz_mask\(\)\s*==\s*4'h4.*?cabac_chroma_ac_cb_plane_nz_mask\(\)\s*==\s*4'h3.*?cabac_chroma_ac_cr_plane_nz_mask\(\)\s*==\s*4'hc.*?cabac_chroma_ac_any_high_amp\(\).*?cabac_chroma_ac_cb_plane_nz_mask\(\)\s*==\s*4'h3.*?cabac_chroma_ac_cr_plane_nz_mask\(\)\s*==\s*4'h5.*?cabac_chroma_ac_cb_plane_nz_mask\(\)\s*==\s*4'h6.*?cabac_chroma_ac_cr_plane_nz_mask\(\)\s*==\s*4'h9.*?!cabac_chroma_ac_cr_plane_has_negative\(\).*?cabac_chroma_ac_cb_plane_nz_mask\(\)\s*==\s*4'h9.*?cabac_chroma_ac_cr_plane_nz_mask\(\)\s*==\s*4'h6.*?cabac_chroma_ac_cb_plane_nz_mask\(\)\s*==\s*4'h5.*?cabac_chroma_ac_cr_plane_nz_mask\(\)\s*==\s*4'h5.*?cabac_chroma_ac_cb_plane_nz_mask\(\)\s*==\s*4'h7.*?cabac_chroma_ac_cr_plane_nz_mask\(\)\s*==\s*4'h7.*?Cb-all-but-one / Cr-singleton.*?Cb-top-row / Cr-bottom-row split-row.*?same-mask 0x7.*?skew-pair lanes.*?left_coded_i\s*=\s*plane_block_i\[0\].*?block_i - 4'd1.*?top_coded_i\s*=\s*\(plane_block_i >= 3'd2\).*?block_i - 4'd2.*?Sparse Cb-only AC needs a dedicated CBF context walk",
    ),
    (
    ...
    (
        "probe_promotes_cross_plane_high_amp_skew_sign_partition",
        "scripts/run_cabac_p16x16_chroma_ac_cross_plane_first_payload_probe.py",
    ...
    (
        ...
        "scripts/run_cabac_p16x16_chroma_ac_cross_plane_first_payload_probe.py",
        r"AMPLITUDE_TAILS\s*=\s*\{.*?\(0x5,\s*0x5,\s*160,\s*160\):\s*\"0000000141d008086b3add\".*?\(0x5,\s*0x5,\s*96,\s*160\):\s*\"0000000141d008086b3add\".*?\(0x5,\s*0x5,\s*160,\s*96\):\s*\"0000000141d008086b7bfd\".*?\(0x5,\s*0x5,\s*96,\s*96\):\s*\"0000000141d008086b7bfd\".*?SAME_MASK_EXPECTED_MISSES\s*=\s*\{\}.*?same-mask checker promoted",
    ),
    (
    ...
    (
        "probe_locks_checker_high_amp_sign_matrix",
        "scripts/run_cabac_p16x16_chroma_ac_checker_high_amp_sign_probe.py",
    ...
    (
        ...
        r"STRICT_TAILS\s*=\s*\{.*?\(0x5,\s*0x5,\s*160,\s*160\):\s*\"0000000141d008086b3add\".*?\(0x5,\s*0x5,\s*96,\s*96\):\s*\"0000000141d008086b7bfd\".*?\(0x7,\s*0x7,\s*160,\s*160\):\s*\"0000000141d008086bfbdf77ed77bdffffbffe\".*?\(0x7,\s*0x7,\s*160,\s*96\):\s*\"0000000141d008086bfbdf77ed77bbdfdff64e\".*?\(0xD,\s*0xD,\s*160,\s*160\):\s*\"0000000141d008086bfadf7d7ede79ffedb7d7\".*?\(0xE,\s*0xE,\s*96,\s*160\):\s*\"0000000141d008086bfbce75777d9feffbf7ba\".*?EXPECTED_MISSES\s*=\s*\{.*?\(0x7,\s*0x7,\s*96,\s*160\):\s*\(FRAME_SIZE,\s*\"bytestream -19\".*?\(0x7,\s*0x7,\s*96,\s*96\):\s*\(FRAME_SIZE,\s*\"bytestream -13\".*?\(0xB,\s*0xB,\s*96,\s*96\):\s*\(FRAME_SIZE,\s*\"bytestream -17\".*?\(0xD,\s*0xD,\s*96,\s*96\):\s*\(FRAME_SIZE,\s*\"bytestream -23\".*?\(0xE,\s*0xE,\s*96,\s*96\):\s*\(FRAME_SIZE,\s*\"bytestream -7\".*?preserving exact one-frame miss signatures",
    ),
    (
    ...
    (
        ...
        r"CB_MASK\s*=\s*0xB.*?CR_MASK\s*=\s*0x4.*?STAGED_SPLIT_CTX.*?4'hb\)\s*&&.*?4'h4.*?STAGED_CB_PAYLOAD_CTX_COND.*?STAGED_DUAL_PAYLOAD_CTX_COND.*?EXPECTED_BASELINE_MISSES\s*=\s*\{.*?\(160,\s*160\):\s*\(\"0000000141d008086bfedff5\",\s*\"bytestream -4\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bffef75\",\s*\"corrupt decoded frame\"\).*?EXPECTED_MISSES\s*=\s*\{.*?cr_payload_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfedffd73\",\s*\"bytestream -3\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bffef7df2\",\s*\"corrupt decoded frame\"\).*?cb_payload_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfacdf5f7\",\s*\"bytestream -11\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bfafe77f7\",\s*\"bytestream -23\"\).*?dual_payload_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfacdf577f4\",\s*\"corrupt decoded frame\"\).*?\(96,\s*96\):\s*\(\"0000000141d008086bfafe77f75d\",\s*\"corrupt decoded frame\"\).*?Cr-side, Cb-side, both-plane,.*?context-class-only.*?split-context extensions",
    ),
    (
        "probe_rejects_b4_context_class_hypotheses",
        "scripts/run_cabac_p16x16_chroma_ac_b4_split_probe.py",
        r"SOURCE_LEVEL0_CTX.*?STAGED_LEVEL0_SHARED_CTX.*?SOURCE_SIG_CTX.*?STAGED_SIG_SHARED_CTX.*?SOURCE_LAST_CTX.*?STAGED_LAST_SHARED_CTX.*?siglast_only_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfedffd73\",\s*\"corrupt decoded frame\"\).*?level_only_split.*?\(96,\s*96\):\s*\(\"0000000141d008086bffef75\",\s*\"corrupt decoded frame\"\).*?sig_only_split.*?\(96,\s*96\):\s*\(\"0000000141d008086bffef7df0\",\s*\"corrupt decoded frame\"\).*?last_only_split.*?\(160,\s*160\):\s*\(\"0000000141d008086bfedff777\",\s*\"corrupt decoded frame\"\).*?context-class-only",
    ),
    (
        "probe_locks_b4_first_payload_substitution",
        "scripts/run_cabac_p16x16_chroma_ac_b4_first_payload_substitution_probe.py",
        r"CB_MASK\s*=\s*0xB.*?CR_MASK\s*=\s*0x4.*?SUBSTITUTED_FIRST_PAYLOAD\s*=\s*0x75.*?BASELINE_CASES\s*=\s*\{.*?\(160,\s*160\):\s*\(0xFE,\s*\"0000000141d008086bfedff5\",\s*\"bytestream -4\"\).*?\(160,\s*96\):\s*\(0xFE,\s*\"0000000141d008086bfedff5\",\s*\"bytestream -4\"\).*?\(96,\s*160\):\s*\(0xFF,\s*\"0000000141d008086bffef75\",\s*\"corrupt decoded frame\"\).*?\(96,\s*96\):\s*\(0xFF,\s*\"0000000141d008086bffef75\",\s*\"corrupt decoded frame\"\).*?mutate_first_payload.*?SUBSTITUTED_FIRST_PAYLOAD.*?assert_planes\(CB_MASK,\s*CR_MASK,\s*fixture,\s*mutated_raw,\s*cb_value,\s*cr_value\).*?first residual payload byte to 0x75 strict-decodes all four",
    ),
    (
        "probe_locks_b4_first_payload_value_classes",
        "scripts/run_cabac_p16x16_chroma_ac_b4_first_payload_value_sweep.py",
        r"CB_MASK.*?CR_MASK.*?KNOWN_PROMOTED\s*=\s*\{0x6B,\s*0x75\}.*?PASS_RANGES\s*=\s*\{.*?\(160,\s*160\):\s*\"0x00-0xa6,0xc5-0xc6,0xd2,0xed,0xef,0xf4-0xf5\".*?\(96,\s*96\):\s*\"0x00-0xa6,0xac,0xaf,0xb4,0xb8,0xc5,0xcd-0xce,0xd5,0xe8,0xeb,0xfc\".*?PASS_COUNTS\s*=\s*\{.*?\(160,\s*160\):\s*174.*?\(96,\s*96\):\s*178.*?first_payload_index\(stream,\s*label,\s*expected_first\).*?baseline first payload 0x\{expected_first:02x\}.*?0xfe/0xff remains outside the strict-decode class while 0x6b/0x75 stay promoted",
    ),
    (
        "probe_locks_b4_second_payload_empty_class",
        "scripts/run_cabac_p16x16_chroma_ac_b4_second_payload_value_sweep.py",
        r"BASELINE_SECOND_PAYLOADS\s*=\s*\{.*?\(160,\s*160\):\s*0xDF.*?\(96,\s*96\):\s*0xEF.*?PASS_RANGES\s*=\s*\{.*?\(160,\s*160\):\s*\"\".*?\(96,\s*96\):\s*\"\".*?PASS_COUNTS\s*=\s*\{.*?\(160,\s*160\):\s*0.*?\(96,\s*96\):\s*0.*?second_idx\s*=\s*first_idx \+ 1.*?single-second-byte pass_count=\{len\(pass_values\)\}.*?locks an empty strict-decode class",
    ),
    (
        "probe_locks_b4_third_payload_empty_class",
        "scripts/run_cabac_p16x16_chroma_ac_b4_third_payload_value_sweep.py",
        r"BASELINE_THIRD_PAYLOADS\s*=\s*\{.*?\(160,\s*160\):\s*0xF5.*?\(96,\s*96\):\s*0x75.*?PASS_RANGES\s*=\s*\{.*?\(160,\s*160\):\s*\"\".*?\(96,\s*96\):\s*\"\".*?PASS_COUNTS\s*=\s*\{.*?\(160,\s*160\):\s*0.*?\(96,\s*96\):\s*0.*?third_idx\s*=\s*first_idx \+ 2.*?single-third-byte pass_count=\{len\(pass_values\)\}.*?locks an empty strict-decode class",
    ),
    (
        "probe_locks_b4_payload_boundary",
        "scripts/run_cabac_p16x16_chroma_ac_b4_payload_boundary_probe.py",
        r"PAYLOAD_BYTES_AFTER_HEADER\s*=\s*3.*?BASELINE_SECOND_PAYLOADS.*?BASELINE_THIRD_PAYLOADS.*?fourth_idx\s*=\s*first_idx \+ 3.*?final_payload_len\s*=\s*len\(stream\) - first_idx.*?no_fourth_payload=True.*?there is no generated fourth payload byte to sweep",
    ),
    (
        "probe_locks_b4_terminal_state",
        "scripts/run_cabac_p16x16_chroma_ac_b4_terminal_state_probe.py",
        r"DEBUG_CABAC terminal-state probe.*?EXPECTED_TERMINAL\s*=\s*\{.*?19a.*?17e.*?19a.*?17e.*?EXPECTED_TERMINAL_RANGE\s*=.*?270.*?final_flush_bytes.*?payload_ctx_selects.*?any\(sel >= 16 for sel in selects\).*?terminating arithmetic low/range",
    ),
    (
    ...
    (
        ...
        r"shared_cb1_cre_160_160.*?\"tail\":\s*\"0000000141d008086b3bcdfd\".*?shared_cb1_cre_096_160.*?\"tail\":\s*\"0000000141d008086b3bcdfd\".*?shared_cb1_cre_160_096.*?\"tail\":\s*\"0000000141d008086b3add75\".*?promoted_cb2_crd_160_160.*?\"tail\":\s*\"0000000141d008086b3aec7fe6\".*?promoted_cb2_crd_096_096.*?\"tail\":\s*\"0000000141d008086b3adefdfc\".*?promoted_cb4_crb_160_160.*?\"tail\":\s*\"0000000141d008086b3bcf7fbf\".*?promoted_cb4_crb_096_096.*?\"tail\":\s*\"0000000141d008086b3becf57f\".*?shared_cb8_cr7_096_160.*?\"tail\":\s*\"0000000141d008086b7fcdff\".*?shared_cb8_cr7_160_096.*?\"tail\":\s*\"0000000141d008086b7eddf7\".*?shared_cb8_cr7_096_096.*?\"tail\":\s*\"0000000141d008086b7eddf7\".*?reciprocal_cbe_cr1_096_096.*?\"tail\":\s*\"0000000141d008086b7fecfff7\".*?reciprocal_cbd_cr2_096_096.*?\"tail\":\s*\"0000000141d008086b3bed75\".*?reciprocal_cb7_cr8_096_096.*?\"tail\":\s*\"0000000141d008086b7bce757f\".*?payload_ctx_selects.*?high_payload_ctx_summary.*?selector >= 16.*?saw_split_bank\s*=\s*any\(sel >= 16.*?expected_high_summary.*?4 \+ idx, 24, 17, 5.*?former Cb0x2/Cr0xd.*?Cb0x4/Cr0xb.*?mixed-sign Cb0x1/Cr0xe.*?Cb0x8/Cr0x7.*?Cb0xe/Cr0x1.*?Cb0xd/Cr0x2.*?Cb0x7/Cr0x8"
    ),
    (
    ...
    (
        "gate_locks_luma_sparse_cross_plane_chroma_ac_pairs",
        "scripts/run_cabac_p16x16_luma_sparse_chroma_ac_residual_check.py",
        r"luma \+ sparse chroma-AC residual.*?all four single-plane Cb/Cr\s+quadrants.*?same-plane row/column pairs.*?same-block Cb\+Cr quadrant cases.*?both\s+row-adjacent directions.*?both\s+column-adjacent directions.*?opposite-diagonal Cb\+Cr pairs.*?name=\"cb_ac_m1\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76955d4\".*?name=\"cb_ac_m2\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76a08ea\".*?name=\"cb_ac_m4\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76a46\".*?name=\"cb_ac_m8\".*?name=\"cb_ac_m3\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76c734600000300\".*?expected_u_sad=128.*?name=\"cb_ac_m5\".*?expected_cavlc_suppressed_bits=166.*?name=\"cb_ac_m10\".*?name=\"cb_ac_m12\".*?expected_cavlc_suppressed_bits=168.*?name=\"cr_ac_m1\".*?name=\"cr_ac_m2\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76a408b\".*?name=\"cr_ac_m4\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76a3db8\".*?name=\"cr_ac_m8\".*?name=\"cr_ac_m3\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76ad6a000000300\".*?expected_v_sad=128.*?name=\"cr_ac_m5\".*?expected_cavlc_suppressed_bits=166.*?name=\"cr_ac_m10\".*?name=\"cr_ac_m12\".*?expected_cavlc_suppressed_bits=168.*?name=\"cbcr_ac_m1\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76966740000\".*?name=\"cbcr_ac_m2\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76a57890000\".*?name=\"cbcr_ac_m4\".*?expected_final_slice=\"0000000141d008086b3ab6e931d045573d34f76a1f1a0000\".*?name=\"cbcr_ac_m2_1\".*?name=\"cbcr_ac_m4_8\".*?name=\"cbcr_ac_m1_2\".*?name=\"cbcr_ac_m8_4\".*?name=\"cbcr_ac_m1_4\".*?name=\"cbcr_ac_m4_1\".*?name=\"cbcr_ac_m2_8\".*?name=\"cbcr_ac_m8_2\".*?name=\"cbcr_ac_m1_8\".*?name=\"cbcr_ac_m8_1\".*?name=\"cbcr_ac_m2_4\".*?name=\"cbcr_ac_m4_2\".*?expected_cavlc_suppressed_bits=162.*?expected_u_sad=64.*?expected_v_sad=64.*?all single-plane quadrants, same-plane row/column pairs, same-quadrant, row-adjacent both directions, column-adjacent both directions, opposite-diagonal mixed-plane pairs",
    ),
    (
        "gate_locks_luma_sparse_two_block_complements",
        "scripts/run_cabac_p16x16_luma_sparse_chroma_ac_residual_check.py",
        r"complementary two-block row/column pairs.*?name=\"cbcr_ac_m3_12\".*?cb_mask=0x3.*?cr_mask=0xC.*?expected_final_slice=\"0000000141d008086b3abfe97ff9\".*?expected_cavlc_suppressed_bits=196.*?expected_u_sad=128.*?expected_v_sad=128.*?name=\"cbcr_ac_m12_3\".*?expected_final_slice=\"0000000141d008086b3ab6ed33f7\".*?name=\"cbcr_ac_m5_10\".*?cb_mask=0x5.*?cr_mask=0xA.*?expected_final_slice=\"0000000141d008086b3abfebb1d8\".*?expected_cavlc_suppressed_bits=192.*?name=\"cbcr_ac_m10_5\".*?expected_final_slice=\"0000000141d008086b3abfff31d8\".*?complementary two-block row/column mixed-plane pairs",
    ),
    (
        "gate_locks_luma_sparse_high_amp_pairs",
        "scripts/run_cabac_p16x16_luma_sparse_chroma_ac_residual_check.py",
        r"high-amplitude same-quadrant and row/column-complement subsets.*?complementary split-row/column \+/-32 sign matrix.*?cb_sample_value: int = 136.*?cr_sample_value: int = 136.*?name=\"cbcr_ac_m1_hi\".*?cb_mask=0x1.*?cr_mask=0x1.*?expected_final_slice=\"0000000141d008086b3af6fd7bdd\".*?expected_cavlc_suppressed_bits=234.*?expected_u_sad=256.*?expected_v_sad=256.*?name=\"cbcr_ac_m2_hi\".*?expected_final_slice=\"0000000141d008086b3abfed3bd9\".*?name=\"cbcr_ac_m4_hi\".*?expected_final_slice=\"0000000141d008086b3afeed7df9\".*?name=\"cbcr_ac_m8_hi\".*?expected_final_slice=\"0000000141d008086b3af6fbf9d8\".*?expected_cavlc_suppressed_bits=230.*?name=\"cbcr_ac_m3_12_hi\".*?cb_mask=0x3.*?cr_mask=0xC.*?expected_final_slice=\"0000000141d008086b3af6f9f3d6d5d77f74f7ff\".*?expected_cavlc_suppressed_bits=301.*?expected_u_sad=512.*?expected_v_sad=512.*?cb_sample_value=160.*?cr_sample_value=160.*?name=\"cbcr_ac_m12_3_hi\".*?expected_final_slice=\"0000000141d008086b3abffbf9fb775ffdf6fffe\".*?name=\"cbcr_ac_m5_10_hi\".*?expected_final_slice=\"0000000141d008086b3af6fdf3d6ef57fdfdf7ef\".*?expected_cavlc_suppressed_bits=297.*?name=\"cbcr_ac_m10_5_hi\".*?expected_final_slice=\"0000000141d008086b3abefffdf5ff57fdfdf7ef\".*?sample_value if \(\(x \+ y\) & 1\).*?expected_u_block_sad = abs\(case\.cb_sample_value - 128\) \* 8.*?high-amplitude same-quadrant pairs.*?high-amplitude complementary split-row/column \+/-32 sign matrix",
    ),
    (
        "gate_locks_luma_sparse_high_amp_complement_sign_matrix",
        "scripts/run_cabac_p16x16_luma_sparse_chroma_ac_residual_check.py",
        r"name=\"cbcr_ac_m3_12_hi\".*?expected_final_slice=\"0000000141d008086b3af6f9f3d6d5d77f74f7ff\".*?name=\"cbcr_ac_m3_12_hi_cbpos_crneg\".*?expected_final_slice=\"0000000141d008086b3af6f9f3d6d5d77f7df77f\".*?expected_cavlc_suppressed_bits=298.*?cb_sample_value=160.*?cr_sample_value=96.*?name=\"cbcr_ac_m3_12_hi_cbneg_crpos\".*?expected_final_slice=\"0000000141d008086b3abfebf3d245577f74f7ff\".*?expected_cavlc_suppressed_bits=300.*?cb_sample_value=96.*?cr_sample_value=160.*?name=\"cbcr_ac_m3_12_hi_cbneg_crneg\".*?expected_final_slice=\"0000000141d008086b3abfebf3d245577f7df77f\".*?expected_cavlc_suppressed_bits=297.*?name=\"cbcr_ac_m12_3_hi\".*?expected_final_slice=\"0000000141d008086b3abffbf9fb775ffdf6fffe\".*?name=\"cbcr_ac_m12_3_hi_cbpos_crneg\".*?expected_final_slice=\"0000000141d008086b3abffbf9fb775ffdb4fffe\".*?expected_cavlc_suppressed_bits=300.*?cb_sample_value=160.*?cr_sample_value=96.*?name=\"cbcr_ac_m12_3_hi_cbneg_crpos\".*?expected_final_slice=\"0000000141d008086b3abfebf9f94f7ffdf6fffe\".*?expected_cavlc_suppressed_bits=298.*?cb_sample_value=96.*?cr_sample_value=160.*?name=\"cbcr_ac_m12_3_hi_cbneg_crneg\".*?expected_final_slice=\"0000000141d008086b3abfebf9f94f7ffdb4fffe\".*?expected_cavlc_suppressed_bits=297.*?name=\"cbcr_ac_m5_10_hi\".*?expected_final_slice=\"0000000141d008086b3af6fdf3d6ef57fdfdf7ef\".*?name=\"cbcr_ac_m5_10_hi_cbpos_crneg\".*?expected_final_slice=\"0000000141d008086b3af6fdf3d6ef77fd34f77c\".*?expected_cavlc_suppressed_bits=294.*?cb_sample_value=160.*?cr_sample_value=96.*?name=\"cbcr_ac_m5_10_hi_cbneg_crpos\".*?expected_final_slice=\"0000000141d008086b3affedf3d26557fdfdf7ef\".*?expected_cavlc_suppressed_bits=296.*?cb_sample_value=96.*?cr_sample_value=160.*?name=\"cbcr_ac_m5_10_hi_cbneg_crneg\".*?expected_final_slice=\"0000000141d008086b3affedf3d25ff7fd34f77c\".*?expected_cavlc_suppressed_bits=293.*?name=\"cbcr_ac_m10_5_hi\".*?expected_final_slice=\"0000000141d008086b3abefffdf5ff57fdfdf7ef\".*?name=\"cbcr_ac_m10_5_hi_cbpos_crneg\".*?expected_final_slice=\"0000000141d008086b3abefffdf5fffffd37fffdff\".*?expected_cavlc_suppressed_bits=296.*?cb_sample_value=160.*?cr_sample_value=96.*?name=\"cbcr_ac_m10_5_hi_cbneg_crpos\".*?expected_final_slice=\"0000000141d008086b3af7fdfdf4c777fdfdf7ef\".*?expected_cavlc_suppressed_bits=294.*?name=\"cbcr_ac_m10_5_hi_cbneg_crneg\".*?expected_final_slice=\"0000000141d008086b3af7fdfdf4c75ffd37fffdfe\".*?expected_cavlc_suppressed_bits=293",
    ),
)
...
def main() -> int:
    ...
    print("[PASS] CABAC chroma residual wiring preserves CBP, scan, context bases, edge-coded plane-local chroma AC CBF context selection, state-dispatch, category scheduling, decoded-plane sanity coverage, dense Cr strict-pass promotion, Cr sparse strict-pass promotion, promoted Cb/Cr chroma-AC mask lattices with exact plane-local SAD, promoted cross-plane Cb+Cr AC strict-decode coverage including skew-pair guards and the full Cb0x3/Cr0xC split-row sign matrix, dense Cb and both-plane AC strict-pass controls plus decoded-plane sanity, chroma AC per-plane block counters, scoped high-amplitude cross-plane Cr payload-bank promotion locks, complementary-checker high-amplitude full sign-matrix coverage, split-row and skew-pair CBF-walk repair-boundary coverage, Cr AC first-payload substitution coverage, B4 first-payload value-class coverage, B4 second/third-payload empty-class, payload-boundary, terminal arithmetic-state, and B4 trace-contrast coverage, refreshed queue-alignment Cb/Cr lattice baseline coverage, Cb/Cr AC promoted shape/amplitude strict-decode coverage, Cr AC promoted shape/amplitude strict-decode coverage, Cb AC phase/polarity tail plus first-payload substitution coverage, Cr AC phase/polarity tail plus first-payload substitution coverage, and combined, sparse same-plane/cross-plane, high-amplitude sparse cross-plane, luma+sparse high-amplitude complement sign-matrix, plus single-plane luma/chroma DC-only/AC residual strict-decode smoke coverage with locked current decoded-plane metrics")
    return 0
