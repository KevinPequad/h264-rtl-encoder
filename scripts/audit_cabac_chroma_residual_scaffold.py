...
CHECKS: tuple[tuple[str, str, str], ...] = (
    ...
    (
        ...
        r"d0 08 08 6b header tail and first residual payload byte eb.*?complementary checker parities plus.*?vertical/horizontal shapes.*?\(0, \"checker_odd\", False, \"bytestream -19\", \"0000000141d008086beb2ed226\"\).*?\(0, \"checker_even\", False, \"bytestream -19\", \"0000000141d008086beb2ed226\"\).*?\(0, \"vert_right\", True, \"\", \"0000000141d008086beb2f\"\).*?\(0, \"horiz_bottom\", False, \"bytestream -23\", \"0000000141d008086beb2e\"\).*?\(1, \"checker_even\", False, \"bytestream -21\", \"0000000141d008086beb2f6b5d\"\).*?\(1, \"horiz_bottom\", True, \"\", \"0000000141d008086beb2f\"\).*?\(2, \"checker_even\", False, \"bytestream -5\", \"0000000141d008086beb2fa1d4\"\).*?\(3, \"checker_even\", True, \"\", \"0000000141d008086beb2fc5f8\"\).*?\(3, \"vert_right\", False, \"bytestream -6\", \"0000000141d008086beb2fc7\"\).*?\(3, \"horiz_bottom\", False, \"bytestream -18\", \"0000000141d008086beb2fc5\"\).*?final_slice\.startswith\(\"0000000141d008086beb\"\).*?repair target is residual coefficient emission/order/arithmetic tail",
    ),
)
