...
middle-left/middle-right, and corner-left/corner-right all-but-one mirrors under
luma residual.
...
CASES = (
    ...
    Case(
        name="cbcr_ac_m7_hi_same_cbpos_crneg",
        cb_mask=0x7,
        cr_mask=0x7,
        expected_final_slice="0000000141d008086b3abf",
        expected_cavlc_suppressed_bits=356,
        expected_y_sad=EXPECTED_Y_SAD,
        expected_u_sad=768,
        expected_v_sad=768,
        cb_sample_value=160,
    ...
    Case(
        name="cbcr_ac_m7_hi_same_cbneg_crpos",
        cb_mask=0x7,
        cr_mask=0x7,
        expected_final_slice="0000000141d008086b3ab7",
        expected_cavlc_suppressed_bits=356,
    ...
    Case(
        name="cbcr_ac_m7_hi_same_cbneg_crneg",
        cb_mask=0x7,
        cr_mask=0x7,
        expected_final_slice="0000000141d008086b3abf",
        expected_cavlc_suppressed_bits=352,
        expected_y_sad=EXPECTED_Y_SAD,
        expected_u_sad=768,
        expected_v_sad=768,
        cb_sample_value=96,
    ...
    Case(
        name="cbcr_ac_m11_hi_same",
        cb_mask=0xB,
        cr_mask=0xB,
        expected_final_slice="0000000141d008086b3af6fd",
        expected_cavlc_suppressed_bits=358,
        expected_y_sad=EXPECTED_Y_SAD,
        expected_u_sad=768,
        expected_v_sad=768,
        cb_sample_value=160,
    ...
    Case(
        name="cbcr_ac_m13_hi_same",
        cb_mask=0xD,
        cr_mask=0xD,
        expected_final_slice="0000000141d008086b3abe",
        expected_cavlc_suppressed_bits=358,
        expected_y_sad=EXPECTED_Y_SAD,
        expected_u_sad=768,
        expected_v_sad=768,
    ...
    Case(
        name="cbcr_ac_m14_hi_same",
        cb_mask=0xE,
        cr_mask=0xE,
        expected_final_slice="0000000141d008086b3aff",
        expected_cavlc_suppressed_bits=362,
        expected_y_sad=EXPECTED_Y_SAD,
        expected_u_sad=768,
        expected_v_sad=768,
        cb_sample_value=160,
