...
try the reciprocal Cb-all-but-one/Cr-singleton `0xb/0x4` mask through both the
Cr-side and Cb-side payload-bank extensions, then proves the four +/-32 sign
combinations still short-decode.  That keeps the next repair search from
repeating these too-simple context-bank extensions.
"""
...
def main() -> int:
    ...
    print(
        ...
        "Cr-side and Cb-side split-context extensions: all four +/-32 reciprocal "
