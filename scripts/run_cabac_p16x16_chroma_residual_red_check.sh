...
# Pair them with high-bit-depth 4:2:2 DC-only probes so the widened eight-entry
# chroma DC coefficient path is independently guarded in the 10-bit lane.
...
def require_strict_framehash_changes(name):
    """Guard strict-decodable chroma residual probes against neutral concealment.

    A strict FFmpeg decode pass only proves syntax survivability.  For the
    currently-green 10-bit 4:2:2 chroma-DC isolation lanes, also require the
    decoded P frame hash to differ from the neutral IDR frame so these probes
    remain reconstruction evidence rather than silent no-op streams.
    """
    output_path = out_dir / f"{name}.h264"
    framehash_log = out_dir / f"{name}.framehash.log"
    fh = subprocess.run(
    ...
    if len(frame_lines) != 2:
        raise SystemExit(f"{name} expected two strict framehash rows, got {len(frame_lines)}")
    hashes = [line.rsplit(",", 1)[-1].strip() for line in frame_lines]
    if hashes[0] == hashes[1]:
        raise SystemExit(
...
def run_chroma_probe(
    ...
    if require_changed_framehash:
        require_strict_framehash_changes(name)
...
try:
    ...
    run_chroma_probe(
        sim_bin_10b422,
        "cabac_p16x16_chroma_dc_residual_10b422_probe",
        dc_10b422_input_path,
        require_dc_only=True,
        require_luma_empty=True,
    ...
    run_chroma_probe(
        sim_bin_10b422,
        "cabac_p16x16_chroma_dc_residual_10b422_cr_neg_large_only_probe",
        dc_10b422_cr_neg_large_only_input_path,
        require_dc_only=True,
        expected_dc_planes=("cr",),
        expected_nonzero_dc_planes=("cr",),
        require_luma_empty=True,
    ...
    if os.environ.get("CABAC_EXPECT_10B422_DC_ISOLATION_FAIL") == "1":
        ...
        xfail_cases = [
            ...
            (
                "cabac_p16x16_chroma_dc_residual_10b422_cb_neg_small_only_probe",
                dc_10b422_cb_neg_small_only_input_path,
                ("cb",),
                "bytestream -14",
                True,
                (),
            ...
            (
                "cabac_p16x16_chroma_dc_residual_10b422_cb_neg_large_only_probe",
                dc_10b422_cb_neg_large_only_input_path,
                ("cb",),
                "bytestream -18",
                True,
                (),
            ...
            (
                ...
                dc_10b422_cb_pos_unity_cr_neg_small_input_path,
                ("cb", "cr"),
                "bytestream -11",
                False,
                ("cb",),
            ...
            (
                "cabac_p16x16_chroma_dc_residual_10b422_cb_pos_large_cr_neg_tiny_probe",
                dc_10b422_cb_pos_large_cr_neg_tiny_input_path,
                ("cb", "cr"),
                "bytestream -11",
                True,
                ("cb",),
            ...
            (
                "cabac_p16x16_chroma_dc_residual_10b422_cb_pos_small_cr_neg_tiny_probe",
                dc_10b422_cb_pos_small_cr_neg_tiny_input_path,
                ("cb", "cr"),
                "bytestream -7",
                True,
                ("cb",),
            ...
            (
                "cabac_p16x16_chroma_dc_residual_10b422_cb_pos_tiny_cr_neg_large_probe",
                dc_10b422_cb_pos_tiny_cr_neg_large_input_path,
                ("cb", "cr"),
                "bytestream -15",
                True,
                ("cb",),
            ...
            (
                "cabac_p16x16_chroma_dc_residual_10b422_cb_neg_tiny_cr_neg_tiny_probe",
                dc_10b422_cb_neg_tiny_cr_neg_tiny_input_path,
                ("cb", "cr"),
                "bytestream -10",
                True,
                (),
            ...
            (
                "cabac_p16x16_chroma_dc_residual_10b422_cr_neg_tiny_only_probe",
                dc_10b422_cr_neg_tiny_only_input_path,
                ("cr",),
                "bytestream -6",
                True,
                (),
