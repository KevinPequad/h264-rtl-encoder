...
checks = {
    ...
    "bitstream_has_chroma_payload_cursor_state": "reg        cabac_res_payload_is_chroma;" in bitstream and "reg        cabac_res_chroma_payload_is_dc;" in bitstream and "reg        cabac_res_chroma_plane_is_cr;" in bitstream and "reg [3:0]  cabac_res_chroma_blk_idx;" in bitstream and "reg [3:0]  cabac_res_payload_coeff_limit;" in bitstream,
    ...
    "bitstream_resets_chroma_payload_cursor_state": bitstream.count("cabac_res_payload_is_chroma <= 1'b0;") >= 2 and bitstream.count("cabac_res_chroma_payload_is_dc <= 1'b0;") >= 2 and bitstream.count("cabac_res_chroma_plane_is_cr <= 1'b0;") >= 2 and bitstream.count("cabac_res_chroma_blk_idx <= 4'd0;") >= 2 and bitstream.count("cabac_res_payload_coeff_limit <= 4'd0;") >= 2,
