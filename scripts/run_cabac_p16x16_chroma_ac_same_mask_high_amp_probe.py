...
rows and preserves exact one-frame FFmpeg miss signatures for the remaining
all-but-one rows so future repairs can prove real promotions instead of relying
on stale status text.
"""
