...
int main(int argc, char** argv) {
    ...
    fprintf(stderr, "  Frames: %d  Resolution: %dx%d  chroma_format_idc=%d  idr_interval=%d  force_b_slice=%d  force_bref_slice=%d  force_b_bi=%d  force_b_direct=%d  reorder_b_gop=%d\n",
            num_frames, FRAME_WIDTH, FRAME_HEIGHT, CHROMA_IDC, idr_interval, force_b_slice ? 1 : 0, force_bref_slice ? 1 : 0, force_b_bi ? 1 : 0, force_b_direct ? 1 : 0, reorder_b_gop ? 1 : 0);
    fprintf(stderr, "==========================================================\n");
